...
@QuickEventListener
public class HttpMsgEventListener extends BaseEventListener<HttpMsgEventListener.Event> {
	public static Logger logger = Logger.getLogger(HttpMsgEventListener.class);
    public HttpMsgEventListener() {
    }

    @Override
    public Object handleEvent(HttpMsgEventListener.Event event) {
