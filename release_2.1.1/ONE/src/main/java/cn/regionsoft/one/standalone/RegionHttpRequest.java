...
public class RegionHttpRequest implements HttpServletRequest{
	...
	public Cookie[] getCookies() {
		...
		if(CommonUtil.isEmpty(cookieStr))return null;
		...
		for(String tmp:cookieArray){
			...
			cookies[i++] = new Cookie(tmpArray[0].trim(),tmpArray[1].trim());
		}
	...
	public String getParameter(String name) {
		...
		String[] result = this.requestMap.get(name);
